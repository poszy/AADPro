...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent getIntentFromChild = getIntent();

        // TODO (4) Create an if statement to check if this Intent has the extra we passed from MainActivity
        if (getIntentFromChild.hasExtra(Intent.EXTRA_TEXT)){
            String textEntered = getIntentFromChild.getStringExtra(Intent.EXTRA_TEXT);
