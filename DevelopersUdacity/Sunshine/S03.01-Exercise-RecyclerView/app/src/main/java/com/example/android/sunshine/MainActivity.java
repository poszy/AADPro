...
public class MainActivity extends AppCompatActivity {
    ...
    private ForecastAdapter mForecasterAdapater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mForecasterAdapater = new ForecastAdapter();

        // (42) Use mRecyclerView.setAdapter and pass in mForecastAdapter
        mRecyclerView.setAdapter(mForecasterAdapater);
        /*
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                ...
                for (String weatherString : weatherData) {
                    mForecasterAdapater.setWeatherData(weatherData);
                }
            } else {
                showErrorMessage();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            mForecasterAdapater.setWeatherData(null);
            loadWeatherData();
            return true;
        }
