...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    private final ForcastAdapaterOnClickHandler mClickHandler;
    // (1) Add an interface called ForecastAdapterOnClickHandler
    interface ForcastAdapaterOnClickHandler{
    ...
    public ForecastAdapter(ForcastAdapaterOnClickHandler mClickHanders) {

        this.mClickHandler = mClickHanders;
    }
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            mClickHandler.onClickHandler(weatherForDay);
        }
