...
public class SimpleFragment extends Fragment {
    ...
    // This method is called as soon s the fragment is associated with the activity
    // this code makes sure that the host Activity has implemeted the callback interface, if not error out.
    @Override
    ...
    /*
     * Instantiate and return teh fragment to the activity
     * */
