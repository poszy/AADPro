...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // this will check for the screen size and orientation
    ...
    class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            // when the user taps a son gtitle the start app code starts
            //  SongDetailActivty usin an intent with extra data ( the positin of the slected song in the list )
